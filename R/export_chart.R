#’------------------------------------------------------------------------------
#’ WFAPLOT - EXPORT FUNCTIONS
#’ export_chart.R
#’------------------------------------------------------------------------------
#’ 
#' @title export_chart
#' @description This script contains the functions for exporting ggplot charts
#' with and without the WFA logo. 
#’ 
#' @param chart_name Name of ggplot object to export
#' @param file_name File path for exporting
#' @param include_logo Boolean value - include logo?
#' @param export_width Width of exported chart *optional
#' @param export_height Height of exported chart *optional
#' @param export_res Resolution of exported chart *optional
#’ 
#’
#' @export
